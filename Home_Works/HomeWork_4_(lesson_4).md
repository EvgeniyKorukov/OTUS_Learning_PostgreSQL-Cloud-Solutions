...
* Для этого изменим настройки:
  ...
  * Переведем кластер PostgreSQL в асинхронный режим, тем самым мы не будем дожидаться оповещения об операции. 
  ...
  * Отключим запись содержимого каждой страницы в wal при checkpoint
